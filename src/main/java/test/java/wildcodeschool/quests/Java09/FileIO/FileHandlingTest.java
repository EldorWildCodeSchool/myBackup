...
public class FileHandlingTest {
    ...
    public void testReadSortedKundendateiIO() throws IOException {
    ...
    @Test
    // This test is for the optional task of writing a sorted file.
    public void testReadSortedKundendateiNIO() throws IOException {
        File input = new File("src/test/resources/sorted_kunden_2.csv");
        List<String> lines = Files.readAllLines(input.toPath());
        List<Kunde> kunden = new ArrayList<>();
        for (String string : lines) {
            String[] content = string.split(",");
